...
int main()
{
    ...
    { 
        ...
        current_velocity += controller.computeCommand(target_velocity, current_velocity, total_error)*controller.getTstep();
    }

    std::cout << "The final error is " << target_velocity-current_velocity << std::endl;
